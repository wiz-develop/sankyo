...
?>
<div id="container">
				<script type="text/javascript" src="<?php echo home_url(); ?>/examples/example.js"></script>

<!--メールフォームプロ-->
<form id="mailformpro" action="<?php echo home_url(); ?>/mailformpro/mailformpro.cgi" method="POST">
	<dl class="mailform">
...
<script type="text/javascript" id="mfpjs" src="<?php echo home_url(); ?>/mailformpro/mailformpro.cgi" charset="UTF-8"></script>
<!--/メールフォームプロ-->
		</div>
